...
### Task 3: Explore service types

Modify your MinIO service from `ClusterIP` to `NodePort` and see if you can access it directly from your browser.

### Task 4: Upload timestamped files
...
### Task 5: Create a private bucket
...
### Task 7: Backup and restore a bucket
